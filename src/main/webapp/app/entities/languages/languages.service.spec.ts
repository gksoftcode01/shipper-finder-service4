...
import { Languages } from '@/shared/model/languages.model';
...
describe('Service Tests', () => {
  describe('Languages Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Languages(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Languages', async () => {
        const patchObject = { ...new Languages() };
      ...
      it('should not partial update a Languages', async () => {
