...
export default defineComponent({
  ...
  setup() {
    ...
    const retrieveLanguagess = async () => {
      ...
      try {
        ...
        const res = currentSearch.value
          ? await languagesService().search(currentSearch.value, paginationQuery)
          : await languagesService().retrieve(paginationQuery);
    ...
    const prepareRemove = (instance: ILanguages) => {
    ...
    const removeLanguages = async () => {
      try {
        await languagesService().delete(removeId.value);
        const message = t$('shipperfinderservice4App.languages.deleted', { param: removeId.value }).toString();
    ...
    watch([languages, page], async ([data, page], [_prevData, prevPage]) => {
