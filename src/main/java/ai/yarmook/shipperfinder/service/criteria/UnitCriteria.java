...
/**
 * Criteria class for the {@link ai.yarmook.shipperfinder.domain.Unit} entity. This class is used
 * in {@link ai.yarmook.shipperfinder.web.rest.UnitResource} to receive all the possible filtering options from
...
public class UnitCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, nameEn, nameAr, nameFr, nameDe, nameUrdu, distinct);
    }
