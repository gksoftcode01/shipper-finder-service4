...
public class TagAsserts {
    ...
    public static void assertTagUpdatableRelationshipsEquals(Tag expected, Tag actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getTripItems()).as("check tripItems").isEqualTo(expected.getTripItems()))
            .satisfies(a -> assertThat(a.getCargoRequestItems()).as("check cargoRequestItems").isEqualTo(expected.getCargoRequestItems()));
    }
}
